...
bool D3DApp::InitMainWindow()
{
	...
	mhMainWnd = CreateWindow(L"D3DWndClassName", (LPCWSTR)mMainWndCaption.c_str(), 
...
//    createDeviceFlags |= D3D11_CREATE_DEVICE_DEBUG;
	...
	//dxgiFactory->EnumAdapters(NULL, &dxgiAdapter);  
	IDXGIOutput* adapterOutput;
	unsigned int numModes;
	dxgiAdapter->EnumOutputs(0, &adapterOutput);
	

	adapterOutput->GetDisplayModeList(DXGI_FORMAT_R8G8B8A8_UNORM, DXGI_ENUM_MODES_INTERLACED, 
		&numModes, NULL);
...
void D3DApp::CalculateFrameStats()
{
	...
	if( (mTimer.TotalTime() - timeElapsed) >= 1.0f )
	{
		...
		SetWindowText(mhMainWnd, (LPCWSTR)outs.str().c_str());
